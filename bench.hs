...
getHash  = fmap snd . getAnnexSizeAndHash True

main :: IO ()
main = defaultMain
       [ bench "getAnnexSizeAndHash whnf"  $ whnf (getAnnexSizeAndHash True) emptySha1Key
       , bench "getAnnexSizeAndHash nf"    $ nf   (getAnnexSizeAndHash True) emptySha1Key
